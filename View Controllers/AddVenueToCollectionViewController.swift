//
//  AddVenueToCollectionViewController.swift
...
enum AddCollectionIdentifier:String{
...
class AddVenueToCollectionViewController: UIViewController {
    ...
    var favoriteVenueImage = [UIImage]()
        ...
        lazy var collectionView:UICollectionView = {
            ...
            cv.register(AddVenueCollectionViewCell.self, forCellWithReuseIdentifier: AddCollectionIdentifier.addToCollectionCell.rawValue)
            cv.delegate = self
            cv.dataSource = self
...
//            print(favoriteVenueImage.first)
    ...
    extension AddVenueToCollectionViewController: UICollectionViewDataSource{
        func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
            return collections.count
        }
        
        func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
            guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: AddCollectionIdentifier.addToCollectionCell.rawValue, for: indexPath) as? AddVenueCollectionViewCell else {return UICollectionViewCell()}
    ...
    extension AddVenueToCollectionViewController: UICollectionViewDelegateFlowLayout{
